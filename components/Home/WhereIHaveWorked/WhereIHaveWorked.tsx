...
import BDBAI from "./Descriptions/BDBAI";
...
import SSPvtLtd from "./Descriptions/SSPvtLtd";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("BDBAI");
  return (
    <div
      data-aos="fade-up"
    ...
    >
      ...
      <section className="flex flex-row items-center mr-[15rem]">
...
const CompaniesBar = (props) => {
    ...
    return (
     <button
        ...
        className={`flex-none sm:text-sm text-xs text-center md:text-left  hover:text-AAsecondary
             ...
             py-3 md:pl-6 md:px-4 md:w-64 w-32 duration-500
             ${
  ...
  return (
    ...
    >
      ...
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:h-[133px] translate-y-1 md:w-0.5  
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
           <CompanyButton
            ...
            CompanyName="BizViz Technologies Pvt Ltd"
            BarPosition={-10}
            BarAvobePosition={1}
            DescriptionJob="BDBAI"
            CompanyNameBackgroundColorGreen={[true, false, false]}
            setDescriptionJob={props.setDescriptionJob}
            />
          <CompanyButton
            ButtonOrderOfcompanyNameBackgroundColorGreen={1}
            CompanyName="Shradha Software Pvt Ltd"
            BarPosition={40}
          ...
          <CompanyButton
            ...
            DescriptionJob="DomainExpansion"
